...
//=============================================================================
// DESCRIPCION: Este archivo contiene los encabezados de la clase "clsRandom".
//
...
#include <ctime>    // Definiciones para el manejo del clock.
#include <cstdlib>  // Contiene la definicion de "srand".
